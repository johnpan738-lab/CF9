...
public class ExpressionsApp {
    ...
    public static void main(String[] args) {
        ...
        sub = num1 - num2;
        mul = num1 * num2;
        div = num1 / num2;  // H διαιρεση ακεραιων δινει παντα ακεραιο
        mod = num1 % num2;  // Το υπόλοιπο της διαιρεσης

        System.out.printf("Sum: %d, Sub: %d, Mul: %d, Div: %d, Mod: %d%n", sum, sub, mul, div, mod);

        result1 = result1 +1; // αλλαζει την τιμη του result 1 -->1
        result2 += 1; // ειναι το ίδιο με το πανω
        result3++; //ειναι το result3 + 1
